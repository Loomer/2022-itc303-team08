...
class StartPage(tk.Frame): # Arrange Start Page
    ...
    def __init__(self, parent, controller):
        ...
        filecheck_label = tk.Label(self, text = '') #  Label for displaying error message if file not an Xray
...
def upload_button_command(root, filename_label, filecheck_label, upload_button, analyse_button, canvas):
    ...
    # if a valid imag url is entered 
        ...
        if res_proc == 1:
            ...
            filecheck_label.config(text = 'WARNING: File selected is not a valid lung Xray', fg="red")
